...
public class UpdateOpinionUITest {
	...
	public void testUpdateOpinionUI() throws Exception {
		...
		this.driver.findElement(By.id("puntuation")).sendKeys("4");
		this.driver.findElement(By.xpath("//button[@type='submit']")).click();
		Assert.assertEquals("4", this.driver.findElement(By.xpath("//table[@id='opinionsTable']/tbody/tr/td[2]")).getText());
	}
