...
public class CreateDiseaseUITest {
    ...
    @Test
    public void testCreateDiseaseUI() throws Exception {
        ...
        driver.findElement(By.id("symptoms")).sendKeys("dolor de barriga");
        driver.findElement(By.id("severity")).click();
        driver.findElement(By.id("severity")).clear();
        driver.findElement(By.id("severity")).sendKeys("LOW");
        driver.findElement(By.id("cure")).click();
        driver.findElement(By.id("cure")).clear();
        driver.findElement(By.id("cure")).sendKeys("reposo");
        driver.findElement(By.xpath("//button[@type='submit']")).click();
        assertEquals("dolor de barriga", driver.findElement(By.xpath("//td")).getText());
        assertEquals("LOW", driver.findElement(By.xpath("//tr[2]/td")).getText());
        assertEquals("reposo", driver.findElement(By.xpath("//tr[3]/td")).getText());
