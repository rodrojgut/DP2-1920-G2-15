...
public class UpdateChipUITest {
  ...
  @Test
  public void testUpdateChipUI() throws Exception {
    ...
    driver.findElement(By.id("geolocatable")).click();
    driver.findElement(By.id("geolocatable")).clear();
    driver.findElement(By.id("geolocatable")).sendKeys("true");
    driver.findElement(By.xpath("//button[@type='submit']")).click();
